...
// CourseStore implements coursebiz.CourseRepository.
...
func (s *CourseStore) Create(ctx context.Context, course *coursebiz.Course) error {
	return s.db.WithContext(ctx).Create(course).Error
}

// List returns a paginated list of courses for a school.
func (s *CourseStore) List(ctx context.Context, schoolID string, page, size int) ([]coursebiz.Course, int64, error) {
	var courses []coursebiz.Course
	var total int64

	query := s.db.WithContext(ctx).Model(&coursebiz.Course{}).Where("school_id = ?", schoolID)
...
func (s *CourseStore) GetByID(ctx context.Context, id string) (*coursebiz.Course, error) {
	var course coursebiz.Course
...
func (s *CourseStore) GetByInvitationCode(ctx context.Context, code string) (*coursebiz.Course, error) {
	var course coursebiz.Course
...
func (s *CourseStore) Update(ctx context.Context, course *coursebiz.Course) error {
...
func (s *CourseStore) Delete(ctx context.Context, id string) error {
	return s.db.WithContext(ctx).Delete(&coursebiz.Course{}, "id = ?", id).Error
}

// ListByIDs returns course metadata for the provided identifiers.
func (s *CourseStore) ListByIDs(ctx context.Context, ids []string) ([]coursebiz.Course, error) {
	if len(ids) == 0 {
...
func (s *CourseStore) ListAssignments(ctx context.Context, schoolID string, courseID, departmentID, classID string, onlyAssigned bool, page, size int) ([]coursebiz.CourseAssignmentInfo, int64, error) {
	var results []coursebiz.CourseAssignmentInfo
	var total int64
...
func (s *CourseStore) ListWithFilters(ctx context.Context, schoolID string, departmentID, classID string, page, size int) ([]coursebiz.Course, int64, error) {
	var courses []coursebiz.Course
	var total int64

	db := s.db.WithContext(ctx).Model(&coursebiz.Course{}).
...
func (s *CourseStore) ListAssignmentsByCourseIDs(ctx context.Context, courseIDs []string) ([]coursebiz.CourseAssignmentInfo, error) {
	var results []coursebiz.CourseAssignmentInfo
	if len(courseIDs) == 0 {
		return results, nil
	}
...
func (s *CourseStore) ListByStudentID(ctx context.Context, studentID string) ([]coursebiz.Course, error) {
	var courses []coursebiz.Course
	err := s.db.WithContext(ctx).
		Model(&coursebiz.Course{}).
...
// CourseSessionStore implements coursebiz.CourseSessionRepository.
...
func (s *CourseSessionStore) ListBetween(ctx context.Context, start, end time.Time) ([]coursebiz.CourseSession, error) {
	...
	var sessions []coursebiz.CourseSession
...
func (s *CourseSessionStore) ListByClassBetween(ctx context.Context, classID string, start, end time.Time) ([]coursebiz.CourseSession, error) {
...
func (s *CourseSessionStore) ListByTeacherBetween(ctx context.Context, teacherID string, start, end time.Time) ([]coursebiz.CourseSession, error) {
...
func (s *CourseSessionStore) Create(ctx context.Context, session *coursebiz.CourseSession) error {
...
func (s *CourseSessionStore) Exists(ctx context.Context, courseID, classID string, teacherID *string, slotID string, startsAt time.Time) (bool, error) {
	var count int64
	err := s.db.WithContext(ctx).Model(&coursebiz.CourseSession{}).
...
func (s *CourseSessionStore) Update(ctx context.Context, session *coursebiz.CourseSession) error {
	return s.db.WithContext(ctx).Save(session).Error
}

func (s *CourseSessionStore) GetByID(ctx context.Context, id string) (*coursebiz.CourseSession, error) {
	var session coursebiz.CourseSession
