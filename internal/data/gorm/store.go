...
func (s *Store) Create(ctx context.Context, account *identitybiz.Account) error {
	return s.db.WithContext(ctx).Create(account).Error
}

func (s *Store) FindByIdentifier(ctx context.Context, schoolID, identifier string) (*identitybiz.Account, error) {
...
func (s *Store) FindByID(ctx context.Context, id string) (*identitybiz.Account, error) {
	var account identitybiz.Account
...
func (s *Store) ListByIDs(ctx context.Context, ids []string) ([]identitybiz.Account, error) {
	if len(ids) == 0 {
		return nil, nil
	}
...
func (s *Store) UpdateStatus(ctx context.Context, accountID, schoolID string, status sharedbiz.AccountStatus) error {
...
func (s *Store) Update(ctx context.Context, account *identitybiz.Account) error {
...
var _ identitybiz.AccountRepository = (*Store)(nil)
