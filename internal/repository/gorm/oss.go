...
func (s *OssCredentialStore) Create(ctx context.Context, credential *domain.OssCredential) error {
...
func (s *OssPolicyStore) Create(ctx context.Context, policy *domain.OssPolicy) error {
