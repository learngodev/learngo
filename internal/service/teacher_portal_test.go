...
func TestTeacherPortalService_GetAssignmentDetailForbidden(t *testing.T) {
	...
	svc := NewTeacherPortalService(teacherRepo, assignmentRepo, submissionRepo, studentRepo, nil, courseRepo, classRepo, nil, nil)
...
func TestTeacherPortalService_ExportAssignmentGrades(t *testing.T) {
	...
	svc := NewTeacherPortalService(teacherRepo, assignmentRepo, submissionRepo, studentRepo, nil, courseRepo, classRepo, nil, accountRepo)
